...
@Component
@Slf4j
public class S1EntryAction implements Action<StatesEnum, EventsEnum> {
  ...
  public void execute(StateContext<StatesEnum, EventsEnum> context) {
    ...
    if (entity == null) {
      ...
      log.info("Action: Entity {} entering to state {}", entity, context.getTransition().getTarget().getId());
    }
  }
}
